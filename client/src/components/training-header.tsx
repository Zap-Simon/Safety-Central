...
export default function TrainingHeader() {
  return (
    <header className="bg-gradient-to-r from-orange-600 to-orange-700 text-white shadow-lg fixed top-0 left-0 right-0 z-30">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-orange-100 text-xs sm:text-sm truncate">Staff Training</p>
            </div>
          </div>
